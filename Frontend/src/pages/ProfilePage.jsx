...
// //     try {
// //       const res = await axios.put("/users/profile", { name, phone }, { headers });
...
// //     try {
// //       await axios.put("/users/profile/password", { oldPassword, newPassword }, { headers });
// //       setOldPassword("");
// //       setNewPassword("");
...
// //       <div className="mb-4">
// //         <img
// //           src={user.filepath || "/default-profile.png"}
// //           alt="Profile"
...
//       <div className="mb-4">
//         <img
//           src={user.filepath ? `http://localhost:5050${user.filepath}` : "/default-profile.png"}
//           alt="Profile"
//           className="w-24 h-24 rounded-full object-cover mb-2"
//         />
//         <input type="file" onChange={(e) => setImage(e.target.files[0])} />
